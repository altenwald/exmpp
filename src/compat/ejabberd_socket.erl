...
starttls(SocketData, TLSOpts) ->
    {ok, TLSSocket} = compat_tls:tcp_to_tls(SocketData#socket_state.socket, TLSOpts),
    ejabberd_receiver:starttls(SocketData#socket_state.receiver, TLSSocket),
    SocketData#socket_state{socket = TLSSocket, sockmod = compat_tls}.
...
get_peer_certificate(SocketData) ->
    compat_tls:get_peer_certificate(SocketData#socket_state.socket).

get_verify_result(SocketData) ->
    compat_tls:get_verify_result(SocketData#socket_state.socket).
